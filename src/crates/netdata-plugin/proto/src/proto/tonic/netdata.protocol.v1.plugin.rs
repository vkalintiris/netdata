...
pub mod plugin_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn call_function(
            &mut self,
            request: impl tonic::IntoRequest<super::super::FunctionCall>,
        ) -> std::result::Result<
            tonic::Response<super::super::FunctionResult>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/netdata.protocol.v1.plugin.PluginService/CallFunction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "netdata.protocol.v1.plugin.PluginService",
                        "CallFunction",
                    ),
                );
...
pub mod plugin_service_server {
    ...
    pub trait PluginService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn call_function(
            &self,
            request: tonic::Request<super::super::FunctionCall>,
        ) -> std::result::Result<
            tonic::Response<super::super::FunctionResult>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/netdata.protocol.v1.plugin.PluginService/CallFunction" => {
                    ...
                    struct CallFunctionSvc<T: PluginService>(pub Arc<T>);
                    impl<
                        T: PluginService,
                    > tonic::server::UnaryService<super::super::FunctionCall>
                    for CallFunctionSvc<T> {
                        type Response = super::super::FunctionResult;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as PluginService>::call_function(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "netdata.protocol.v1.plugin.PluginService";
