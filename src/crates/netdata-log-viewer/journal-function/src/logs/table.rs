...
///
/// This function takes raw field data and builds a table structure with
/// transformations applied. It only extracts fields that are in the requested
/// columns list.
///
/// # Arguments
///
...
/// * `transformations` - Registry of field transformations to apply
///
/// # Returns
///
/// A `Table` containing the transformed field values
