    ...
    time_t *last_timestamp)
{
    ...
    time_t first_t = 0; // rd->tiers[0]->query_ops->oldest_time(rd->tiers[0]->db_metric_handle);
    time_t last_t = 0; // rd->tiers[0]->query_ops->latest_time(rd->tiers[0]->db_metric_handle);
