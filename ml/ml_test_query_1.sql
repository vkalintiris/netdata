...
SELECT  main.dimension_id,
     ...
     (COALESCE(post.avg,0) * (SELECT before-after FROM anomaly_rate_info_test_source WHERE before >= 1638208583 OR ((SELECT before FROM anomaly_rate_info_test_source
