...
SELECT  main.dimension_id, COALESCE(
     ((COALESCE(pre.avg,0) * (SELECT before-1638208343 FROM anomaly_rate_info_test_source WHERE after < 1638208343 ORDER BY after DESC LIMIT 1)) + 
     ...
     (COALESCE(post.avg,0) * (SELECT 1638208583-after FROM anomaly_rate_info_test_source WHERE before > 1638208583 OR ((SELECT before FROM anomaly_rate_info_test_source 
                                                                ...
                                                                ORDER BY before ASC LIMIT 1))) / 
     ( 
     (SELECT before-1638208343 FROM anomaly_rate_info_test_source WHERE after < 1638208343 ORDER BY after DESC LIMIT 1) + 
     (SELECT before FROM anomaly_rate_info_test_source WHERE before <= 1638208583 ORDER BY before DESC LIMIT 1) - 
     (SELECT after FROM anomaly_rate_info_test_source WHERE after >= 1638208343 ORDER BY after ASC LIMIT 1) + 
     (SELECT 1638208583-after FROM anomaly_rate_info_test_source WHERE before > 1638208583 OR ((SELECT before FROM anomaly_rate_info_test_source 
                                                                                                WHERE before <= 1638208583 
                                                                                                ORDER BY before DESC LIMIT 1) 
                                                                                            AND NOT EXISTS (SELECT before FROM anomaly_rate_info_test_source 
                                                                                                                WHERE before > 1638208583 
    ...
    (SELECT dimension_id, AVG(anomaly_percentage) avg FROM 
      ...
      AND ari.after >= (SELECT after FROM anomaly_rate_info_test_source WHERE after <= 1638208343 ORDER BY after DESC LIMIT 1) 
      AND ari.before <= (SELECT before FROM anomaly_rate_info_test_source WHERE before >= 1638208343 ORDER BY before ASC LIMIT 1) 
      AND json_valid(ari.anomaly_rates)) 
    ...
    (SELECT dimension_id, AVG(anomaly_percentage) avg FROM 
      ...
      FROM anomaly_rate_info_test_source AS ari, json_each(ari.anomaly_rates) AS j 
      WHERE ari.host_id == '5cb28cec-3d65-11ec-83fd-15e0d7613f4b' 
      AND ari.after >= (SELECT after FROM anomaly_rate_info_test_source WHERE after <= 1638208583 ORDER BY after DESC LIMIT 1) 
      AND ari.before <= (SELECT before FROM anomaly_rate_info_test_source WHERE before >= 1638208583 OR ((SELECT before FROM anomaly_rate_info_test_source 
                                                                                                WHERE before <= 1638208583 
                                                                                                ORDER BY before DESC LIMIT 1) 
                                                                                            AND NOT EXISTS (SELECT before FROM anomaly_rate_info_test_source 
                                                                                                            WHERE before >= 1638208583 
