...
extern PARSER_RC pluginsd_label_action(void *user, char *key, char *value, RRDLABEL_SOURCE source);
extern PARSER_RC pluginsd_overwrite_action(void *user, RRDHOST *host, label_list_t new_labels);
extern PARSER_RC pluginsd_clabel_commit_action(void *user, RRDHOST *host, label_list_t new_labels);
extern PARSER_RC pluginsd_clabel_action(void *user, char *key, char *value, RRDLABEL_SOURCE source);
