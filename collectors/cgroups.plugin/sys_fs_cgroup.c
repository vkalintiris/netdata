...
void read_cgroup_plugin_configuration() {
    ...
    cgroup_update_every = (int)config_get_number("plugin:cgroups", "update every", rrdb.localhost->rrd_update_every);
    if(cgroup_update_every < rrdb.localhost->rrd_update_every)
        cgroup_update_every = rrdb.localhost->rrd_update_every;
