...
typedef struct pluginsd_action {
    ...
    PARSER_RC (*label_action)(void *user, char *key, char *value, RRDLABEL_SOURCE source);
    PARSER_RC (*overwrite_action)(void *user, RRDHOST *host, label_t new_labels);
    PARSER_RC (*clabel_action)(void *user, char *key, char *value, RRDLABEL_SOURCE source);
    PARSER_RC (*clabel_commit_action)(void *user, RRDHOST *host, label_t new_labels);
